import flet as ft
from flet import *
from blog_db import get_all_shake_blogs, delete_shake_blog
import os

def page_shake_blog_manage(page: ft.Page):
    # 記事一覧を表示するリスト
    ...
    register_button = ft.ElevatedButton(
        "Shakeブログ登録ページ",
        icon=ft.icons.ADD,
        on_click=lambda _: page.go("/shake_blog/register")
    )
...
if __name__ == "__main__":
    ft.app(target=page_shake_blog_manage)
