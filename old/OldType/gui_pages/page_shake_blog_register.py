...
from blog_db import add_shake_blog, get_all_shake_blogs

def page_shake_blog_register(page: ft.Page):
    # 画像保存先の設定
    IMAGE_DIR = "shake_vanilla/image"
    ...
    return ft.View(
        ...
        [
            ...
            ft.Container(
                content=ft.Column(
                    [
                        ft.Text("Shake新規記事作成", size=30, weight=ft.FontWeight.BOLD),
                        title_input,
                        content_input,
...
if __name__ == "__main__":
    ft.app(target=page_shake_blog_register)
