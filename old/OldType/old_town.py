...
def town_login(headless=True, detach=False):
    ...
    url = "https://admin.dto.jp/a/auth/input?key=a177ddb3625702c7725d1c44d9c5314b"
    ...
    for attempt in range(5):
        try:
            ...
            town_id.click()
            town_id.send_keys("dieselchiba@central-agent.co.jp")
            town_pass.click()
            town_pass.send_keys("dieselchiba")
